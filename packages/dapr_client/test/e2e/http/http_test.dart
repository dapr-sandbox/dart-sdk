...
void main() {
  ...
  final DaprClient daprClient =
      DaprClient(daprHost: daprHost, daprPort: daprPort);
  ...
  group('Dapr Http client - Invoker', () {
  ...
  group('Dapr Http client - publish', () {
    setUp(() async {
  ...
  group('Dapr Http client - Bindings', () {
    setUp(() async {
      // Reset the mock after every test.
  ...
  group("Dapr Http Client - State", () {
    ...
    test("Get state in bulk", () async {
      ...
      expect(result, bulkStateObjects);
    });
